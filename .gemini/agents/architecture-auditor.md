...
description: Systematic auditor of AcePilot's Rigid Layered Architecture. Use this agent to ensure physical isolation, dependency direction, and safety compliance.
skills:
