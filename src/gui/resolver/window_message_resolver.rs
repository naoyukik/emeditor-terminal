...
pub fn on_set_focus(window_id: WindowId) -> isize {
    ...
    let data_arc = get_terminal_data();
    {
        ...
        window_data.caret = Some(crate::gui::driver::ime_gui_driver::CaretHandle::new(window_id, char_width, char_height));
